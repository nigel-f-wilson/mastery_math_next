...
// THIRD PARTY
import { Box, Grid, Button, Container, IconButton, Typography } from '@mui/material';
// ICONS
...
import { ScrollToSectionButton } from "../components/buttons";
import { Navbar } from "../components/navigation";
import { SettingsContext } from "../contexts";
import { ScrollingPage, PageBackground } from "../components/layout";
...
export default function Home() {
  ...
  const whoRef = React.useRef()
  const howRef = React.useRef()
  const whyRef = React.useRef()
  const refs = { whatRef, whoRef, howRef, whyRef }
      ...
      <main className={styles.main}>
        <Box >
          ...
          <PageBackground >
            ...
            <WhoSection id='who' ref={whoRef} />
            <HowSection id='how' ref={howRef} />
            <WhySection id='why' ref={whyRef} />
          </PageBackground>
        </Box>
...
const TitleSection = (props) => {
  ...
  return (
    <FullscreenLandingSection id={id} disableNavbarPadding >
      ...
      <Grid container height="20vh"  width="100%" display='flex' justifyContent="center" >
          <ScrollToSectionButton label="What?" to="#what" refToScrollTo={refs.whatRef} />
          <ScrollToSectionButton label="Who?" to="#who" refToScrollTo={refs.whoRef} />
          <ScrollToSectionButton label="How?" to="#how" refToScrollTo={refs.howRef} />
          <ScrollToSectionButton label="Why?" to="#why" refToScrollTo={refs.whyRef} />
      </Grid>
...
const WhatSection = React.forwardRef((props, ref) => {
  const { id } = props
  return (
    <div ref={ref} >
      ...
      <FullscreenLandingSection id={id}   >
        ...
        <Grid container py={2} spacing={1} >
          <Grid item xs={12} sm={6} >
            <PageLinkButton href="for/students" label="For Students" />
          </Grid>
          <Grid item display={{xs: 'none', sm: 'flex'}} width="100%" xs={6} >
            <PageLinkButton href="for/parents" label="For Parents" />
          </Grid>
          <Grid item xs={12} sm={6} >
            <PageLinkButton href="for/teachers" label="For Teachers" />
          </Grid>
          <Grid item display={{xs: 'none', sm: 'flex'}} width="100%" xs={6} >
            <PageLinkButton href="for/administrators" label="For Schools" />
          </Grid>
        </Grid>
        ...
        <Grid container py={2} spacing={1} >
          <Grid item xs={12} sm={6} >
            <PageLinkButton href="meet-nigel" label="Meet Nigel" />
          </Grid>
          <Grid item xs={12} sm={6} >
            <PageLinkButton href="contact" label="Get Involved" />
          </Grid>
        </Grid>
        {/* <Paragraph 
